...
export function Footer() {
  return (
    <footer className="relative overflow-hidden bg-background/40 backdrop-blur-sm">
      {/* Gradient top border */}
      <div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-primary/20 to-transparent" />

      {/* Background gradient orb for continuity */}
      <div className="gradient-orb gradient-orb-blue absolute -bottom-40 left-1/2 h-80 w-[600px] -translate-x-1/2 opacity-10" />
        ...
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            <Link href="/" className="inline-block">
              <GradientText className="font-heading text-xl font-bold">
                {COMPANY.name}
              </GradientText>
            </Link>
            ...
            <div className="mt-6 flex items-center gap-3">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="flex h-9 w-9 items-center justify-center rounded-lg border border-border text-text-muted transition-all duration-200 hover:border-border-hover hover:text-primary hover:drop-shadow-[0_0_8px_rgba(59,164,255,0.4)]"
            ...
            <ul className="mt-4 space-y-3">
              <li>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-start gap-2 text-sm text-text-muted transition-colors duration-200 hover:text-primary"
                >
      ...
      <div className="relative border-t border-white/5">
        <Container className="relative flex flex-col items-center justify-between gap-4 py-6 sm:flex-row">
